...
async def run(message: str):
    # Define the system prompt for the healthcare chatbot
    system_prompt = SystemMessage(content=(
        ...
        "Be empathetic, concise, and avoid diagnostics "
        "or treatment advice. Always encourage consulting a licensed healthcare provider."
    ))
